...
namespace CMA.Extensions.Model
{
	...
	public partial class Email : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Microsoft.Xrm.Sdk.EntityReference msdyn_emailclassificationcategory
		{
			...
			set
			{
				this.OnPropertyChanging("msdyn_emailclassificationcategory");
				this.SetAttributeValue("msdyn_emailclassificationcategory", value);
				this.OnPropertyChanged("msdyn_emailclassificationcategory");
			}
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_lobbyingactivity")]
		public System.Nullable<bool> new_LobbyingActivity
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("new_lobbyingactivity");
			}
			set
			{
				this.OnPropertyChanging("new_LobbyingActivity");
				this.SetAttributeValue("new_lobbyingactivity", value);
				this.OnPropertyChanged("new_LobbyingActivity");
			}
		}
		
		/// <summary>
		/// The persisted Email Original Queue.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_originatingemailqueue")]
		public Microsoft.Xrm.Sdk.EntityReference new_OriginatingEmailQueue
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("new_originatingemailqueue");
			}
			set
			{
				this.OnPropertyChanging("new_OriginatingEmailQueue");
				this.SetAttributeValue("new_originatingemailqueue", value);
				this.OnPropertyChanged("new_OriginatingEmailQueue");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_subtype")]
		public virtual new_subtype_email? new_SubType
		{
			get
			{
				return ((new_subtype_email?)(EntityOptionSetEnum.GetEnum(this, "new_subtype")));
			}
			set
			{
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Annotation> Email_Annotation
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Annotation>("Email_Annotation", null);
			}
			set
			{
				this.OnPropertyChanging("Email_Annotation");
				this.SetRelatedEntities<CMA.Extensions.Model.Annotation>("Email_Annotation", null, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Connection> email_connections1
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Connection>("email_connections1", null);
			}
			set
			{
				this.OnPropertyChanging("email_connections1");
				this.SetRelatedEntities<CMA.Extensions.Model.Connection>("email_connections1", null, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Connection> email_connections2
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Connection>("email_connections2", null);
			}
			set
			{
				this.OnPropertyChanging("email_connections2");
				this.SetRelatedEntities<CMA.Extensions.Model.Connection>("email_connections2", null, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Email> Referencedemail_email_CorrelatedActivityId
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Email>("email_email_CorrelatedActivityId", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedemail_email_CorrelatedActivityId");
				this.SetRelatedEntities<CMA.Extensions.Model.Email>("email_email_CorrelatedActivityId", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Email> Referencedemail_email_parentactivityid
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Email>("email_email_parentactivityid", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedemail_email_parentactivityid");
				this.SetRelatedEntities<CMA.Extensions.Model.Email>("email_email_parentactivityid", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.QueueItem> Email_QueueItem
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.QueueItem>("Email_QueueItem", null);
			}
			set
			{
				this.OnPropertyChanging("Email_QueueItem");
				this.SetRelatedEntities<CMA.Extensions.Model.QueueItem>("Email_QueueItem", null, value);
		...
		public CMA.Extensions.Model.Account Account_Email_EmailSender
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Account>("Account_Email_EmailSender", null);
			}
		}
		...
		public CMA.Extensions.Model.Account Account_Email_SendersAccount
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Account>("Account_Email_SendersAccount", null);
			}
		}
		...
		public CMA.Extensions.Model.Account Account_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Account>("Account_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.Account>("Account_Emails", null, value);
		...
		public CMA.Extensions.Model.Campaign Campaign_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Campaign>("Campaign_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("Campaign_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.Campaign>("Campaign_Emails", null, value);
		...
		public CMA.Extensions.Model.Contact Contact_Email_EmailSender
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Contact>("Contact_Email_EmailSender", null);
			}
		}
		...
		public CMA.Extensions.Model.Contact Contact_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Contact>("Contact_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.Contact>("Contact_Emails", null, value);
		...
		public CMA.Extensions.Model.Queue email_acceptingentity_queue
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Queue>("email_acceptingentity_queue", null);
			}
			set
			{
				this.OnPropertyChanging("email_acceptingentity_queue");
				this.SetRelatedEntity<CMA.Extensions.Model.Queue>("email_acceptingentity_queue", null, value);
		...
		public CMA.Extensions.Model.SystemUser email_acceptingentity_systemuser
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("email_acceptingentity_systemuser", null);
			}
			set
			{
				this.OnPropertyChanging("email_acceptingentity_systemuser");
				this.SetRelatedEntity<CMA.Extensions.Model.SystemUser>("email_acceptingentity_systemuser", null, value);
		...
		public CMA.Extensions.Model.Email Referencingemail_email_CorrelatedActivityId
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Email>("email_email_CorrelatedActivityId", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingemail_email_CorrelatedActivityId");
				this.SetRelatedEntity<CMA.Extensions.Model.Email>("email_email_CorrelatedActivityId", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public CMA.Extensions.Model.Email Referencingemail_email_parentactivityid
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Email>("email_email_parentactivityid", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingemail_email_parentactivityid");
				this.SetRelatedEntity<CMA.Extensions.Model.Email>("email_email_parentactivityid", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public CMA.Extensions.Model.Lead Lead_Email_EmailSender
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Lead>("Lead_Email_EmailSender", null);
			}
		}
		...
		public CMA.Extensions.Model.Lead Lead_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Lead>("Lead_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("Lead_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.Lead>("Lead_Emails", null, value);
		...
		public CMA.Extensions.Model.SystemUser lk_email_createdby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_email_createdby", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser lk_email_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_email_createdonbehalfby", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser lk_email_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_email_modifiedby", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser lk_email_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_email_modifiedonbehalfby", null);
			}
		}
		
		/// <summary>
		/// N:1 new_email_OriginatingEmailQueue_queue
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_originatingemailqueue")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_email_OriginatingEmailQueue_queue")]
		public CMA.Extensions.Model.Queue new_email_OriginatingEmailQueue_queue
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Queue>("new_email_OriginatingEmailQueue_queue", null);
			}
			set
			{
				this.OnPropertyChanging("new_email_OriginatingEmailQueue_queue");
				this.SetRelatedEntity<CMA.Extensions.Model.Queue>("new_email_OriginatingEmailQueue_queue", null, value);
				this.OnPropertyChanged("new_email_OriginatingEmailQueue_queue");
			}
		}
		
		/// <summary>
		/// N:1 new_event_Emails
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_event_Emails")]
		public CMA.Extensions.Model.new_event new_event_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_event>("new_event_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("new_event_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.new_event>("new_event_Emails", null, value);
				this.OnPropertyChanged("new_event_Emails");
			}
		}
		
		/// <summary>
		/// N:1 new_eventattendee_Emails
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_eventattendee_Emails")]
		public CMA.Extensions.Model.new_eventattendee new_eventattendee_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_eventattendee>("new_eventattendee_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("new_eventattendee_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.new_eventattendee>("new_eventattendee_Emails", null, value);
				this.OnPropertyChanged("new_eventattendee_Emails");
			}
		}
		
		/// <summary>
		/// N:1 new_onlineapplication_Emails
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_onlineapplication_Emails")]
		public CMA.Extensions.Model.new_onlineapplication new_onlineapplication_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_onlineapplication>("new_onlineapplication_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("new_onlineapplication_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.new_onlineapplication>("new_onlineapplication_Emails", null, value);
				this.OnPropertyChanged("new_onlineapplication_Emails");
			}
		}
		
		/// <summary>
		/// N:1 new_subscription_Emails
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_subscription_Emails")]
		public CMA.Extensions.Model.new_subscription new_subscription_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_subscription>("new_subscription_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("new_subscription_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.new_subscription>("new_subscription_Emails", null, value);
		...
		public CMA.Extensions.Model.Opportunity Opportunity_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Opportunity>("Opportunity_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("Opportunity_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.Opportunity>("Opportunity_Emails", null, value);
		...
		public CMA.Extensions.Model.Queue Queue_Email_EmailSender
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Queue>("Queue_Email_EmailSender", null);
			}
		}
		...
		public CMA.Extensions.Model.SalesOrder SalesOrder_Emails
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SalesOrder>("SalesOrder_Emails", null);
			}
			set
			{
				this.OnPropertyChanging("SalesOrder_Emails");
				this.SetRelatedEntity<CMA.Extensions.Model.SalesOrder>("SalesOrder_Emails", null, value);
		...
		public CMA.Extensions.Model.SystemUser SystemUser_Email_EmailSender
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("SystemUser_Email_EmailSender", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser user_email
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("user_email", null);
			}
		}
	}
}
