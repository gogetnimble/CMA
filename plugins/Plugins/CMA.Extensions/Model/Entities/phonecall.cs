...
namespace CMA.Extensions.Model
{
	...
	public partial class PhoneCall : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdyncrm_activityid")]
		public string msdyncrm_ActivityId
		{
			get
			{
				return this.GetAttributeValue<string>("msdyncrm_activityid");
			}
			set
			{
				this.OnPropertyChanging("msdyncrm_ActivityId");
				this.SetAttributeValue("msdyncrm_activityid", value);
				this.OnPropertyChanged("msdyncrm_ActivityId");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msdyncrm_associatedcustomerjourneyiteration")]
		public Microsoft.Xrm.Sdk.EntityReference msdyncrm_associatedcustomerjourneyiteration
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("msdyncrm_associatedcustomerjourneyiteration");
			}
			set
			{
				this.OnPropertyChanging("msdyncrm_associatedcustomerjourneyiteration");
				this.SetAttributeValue("msdyncrm_associatedcustomerjourneyiteration", value);
				this.OnPropertyChanged("msdyncrm_associatedcustomerjourneyiteration");
			}
		}
		...
		/// <summary>
		/// Indicates the category of the call.
		/// </summary>
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Annotation> PhoneCall_Annotation
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Annotation>("PhoneCall_Annotation", null);
			}
			set
			{
				this.OnPropertyChanging("PhoneCall_Annotation");
				this.SetRelatedEntities<CMA.Extensions.Model.Annotation>("PhoneCall_Annotation", null, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Connection> phonecall_connections1
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Connection>("phonecall_connections1", null);
			}
			set
			{
				this.OnPropertyChanging("phonecall_connections1");
				this.SetRelatedEntities<CMA.Extensions.Model.Connection>("phonecall_connections1", null, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.Connection> phonecall_connections2
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.Connection>("phonecall_connections2", null);
			}
			set
			{
				this.OnPropertyChanging("phonecall_connections2");
				this.SetRelatedEntities<CMA.Extensions.Model.Connection>("phonecall_connections2", null, value);
		...
		public System.Collections.Generic.IEnumerable<CMA.Extensions.Model.QueueItem> PhoneCall_QueueItem
		{
			get
			{
				return this.GetRelatedEntities<CMA.Extensions.Model.QueueItem>("PhoneCall_QueueItem", null);
			}
			set
			{
				this.OnPropertyChanging("PhoneCall_QueueItem");
				this.SetRelatedEntities<CMA.Extensions.Model.QueueItem>("PhoneCall_QueueItem", null, value);
		...
		public CMA.Extensions.Model.Account Account_Phonecalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Account>("Account_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Phonecalls");
				this.SetRelatedEntity<CMA.Extensions.Model.Account>("Account_Phonecalls", null, value);
		...
		public CMA.Extensions.Model.Campaign Campaign_Phonecalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Campaign>("Campaign_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("Campaign_Phonecalls");
				this.SetRelatedEntity<CMA.Extensions.Model.Campaign>("Campaign_Phonecalls", null, value);
		...
		public CMA.Extensions.Model.Contact Contact_Phonecalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Contact>("Contact_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Phonecalls");
				this.SetRelatedEntity<CMA.Extensions.Model.Contact>("Contact_Phonecalls", null, value);
		...
		public CMA.Extensions.Model.Lead Lead_Phonecalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Lead>("Lead_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("Lead_Phonecalls");
				this.SetRelatedEntity<CMA.Extensions.Model.Lead>("Lead_Phonecalls", null, value);
		...
		public CMA.Extensions.Model.SystemUser lk_phonecall_createdby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_phonecall_createdby", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser lk_phonecall_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_phonecall_createdonbehalfby", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser lk_phonecall_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_phonecall_modifiedby", null);
			}
		}
		...
		public CMA.Extensions.Model.SystemUser lk_phonecall_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("lk_phonecall_modifiedonbehalfby", null);
			}
		}
		
		/// <summary>
		/// N:1 new_event_PhoneCalls
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_event_PhoneCalls")]
		public CMA.Extensions.Model.new_event new_event_PhoneCalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_event>("new_event_PhoneCalls", null);
			}
			set
			{
				this.OnPropertyChanging("new_event_PhoneCalls");
				this.SetRelatedEntity<CMA.Extensions.Model.new_event>("new_event_PhoneCalls", null, value);
				this.OnPropertyChanged("new_event_PhoneCalls");
			}
		}
		
		/// <summary>
		/// N:1 new_eventattendee_PhoneCalls
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_eventattendee_PhoneCalls")]
		public CMA.Extensions.Model.new_eventattendee new_eventattendee_PhoneCalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_eventattendee>("new_eventattendee_PhoneCalls", null);
			}
			set
			{
				this.OnPropertyChanging("new_eventattendee_PhoneCalls");
				this.SetRelatedEntity<CMA.Extensions.Model.new_eventattendee>("new_eventattendee_PhoneCalls", null, value);
				this.OnPropertyChanged("new_eventattendee_PhoneCalls");
			}
		}
		
		/// <summary>
		/// N:1 new_onlineapplication_PhoneCalls
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_onlineapplication_PhoneCalls")]
		public CMA.Extensions.Model.new_onlineapplication new_onlineapplication_PhoneCalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_onlineapplication>("new_onlineapplication_PhoneCalls", null);
			}
			set
			{
				this.OnPropertyChanging("new_onlineapplication_PhoneCalls");
				this.SetRelatedEntity<CMA.Extensions.Model.new_onlineapplication>("new_onlineapplication_PhoneCalls", null, value);
				this.OnPropertyChanged("new_onlineapplication_PhoneCalls");
			}
		}
		
		/// <summary>
		/// N:1 new_subscription_PhoneCalls
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("new_subscription_PhoneCalls")]
		public CMA.Extensions.Model.new_subscription new_subscription_PhoneCalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.new_subscription>("new_subscription_PhoneCalls", null);
			}
			set
			{
				this.OnPropertyChanging("new_subscription_PhoneCalls");
				this.SetRelatedEntity<CMA.Extensions.Model.new_subscription>("new_subscription_PhoneCalls", null, value);
		...
		public CMA.Extensions.Model.Opportunity Opportunity_Phonecalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.Opportunity>("Opportunity_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("Opportunity_Phonecalls");
				this.SetRelatedEntity<CMA.Extensions.Model.Opportunity>("Opportunity_Phonecalls", null, value);
		...
		public CMA.Extensions.Model.SalesOrder SalesOrder_Phonecalls
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SalesOrder>("SalesOrder_Phonecalls", null);
			}
			set
			{
				this.OnPropertyChanging("SalesOrder_Phonecalls");
				this.SetRelatedEntity<CMA.Extensions.Model.SalesOrder>("SalesOrder_Phonecalls", null, value);
		...
		public CMA.Extensions.Model.SystemUser user_phonecall
		{
			get
			{
				return this.GetRelatedEntity<CMA.Extensions.Model.SystemUser>("user_phonecall", null);
			}
		}
	}
}
